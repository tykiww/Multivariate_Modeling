############################################
# Example file Adapted from https://complementarytraining.net/simple-sensitivity-analysis-with-r/
############################################



############################################
filepath = "https://raw.githubusercontent.com/tykiww/projectpage/master/datasets/jump/jump-data.csv"
...
jumpData <- read.csv(filepath, header = TRUE)
